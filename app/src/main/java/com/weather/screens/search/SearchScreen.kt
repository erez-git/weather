package com.weather.screens.search
...
import com.weather.components.InputField
...
import com.weather.screens.main.getLatLon
...
//                        navController.navigate(BottomNavItem.Home.route + "/$city")
                        ...
                        if (address != null) {
                            ...
                            // Navigate to HomeScreen
                            navController.navigate(BottomNavItem.Home.route + "/" + Constants.DEFAULT_CITY)
        ...
        modifier = Modifier
            ...
            .clickable {
                ...
                if (isConnected) {
                    ...
                    Toast
                        .makeText(context, context.getString(R.string.no_internet), Toast.LENGTH_LONG)
                        .show()
                }
            },
